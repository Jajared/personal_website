...
export const experienceData: ExperienceItemData[] = [
  { company: "VisionPal", company_icon: VisionPalLogo, role: "Software Engineer Intern (Full-Stack)", startDate: "Dec 2023", endDate: "Present", description: "VisionPal aims to transform the eye healthcare scene by making preventative eye care, eye health management and treatments conveniently accessible for users. VisionPal is a one of a kind company within the optometry and eye health industry which provides eye health and prescriptive screenings on the go.", tech_stack: ["React Native", "Javascript"] },
