...
export const projectData: ProjectItemData[] = [
  ...
  { title: "Finance Tracker", description: "Track your personal spending and investments all in a single app!", tech_stack: ["Flutter", "Firebase"], projectImage: FinanceTracker, projectLink: "" },
