...
export const projectData: ProjectItemData[] = [
  { title: "PeerPrep", year: 2024, description: "PeerPrep is a platform that connects students to practice technical interviews with their peers. It provides a seamless experience for users to schedule, conduct and review mock interviews.", techStack: [NextJsIcon, TypescriptIcon, NestJsIcon, MongoDbIcon, RedisIcon, DockerIcon], projectImage: PeerPrep, projectLink: null },
  { title: "HappyLungs", year: 2024, description: "Encouraging users to quit smoking by providing a platform to track cigarette consumption.\n\nDeveloped in collaboration with NUS School of Computing Health Informatics Lab and local health organisations", techStack: [ReactIcon, TypescriptIcon, JavascriptIcon, FirebaseIcon], projectImage: HappyLungs, projectLink: null },
