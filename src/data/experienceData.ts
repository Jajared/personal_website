...
import { DjangoIcon, FirebaseIcon, JavascriptIcon, LangchainIcon, NestJsIcon, NextJsIcon, OpenAIIcon, PostgresqlIcon, PrismaIcon, PythonIcon, ReactIcon, TypescriptIcon } from "../components/DevIcons";
...
export const experienceData: ExperienceItemData[] = [
  ...
  { company: "Holicay", company_icon: HolicayLogo, role: "Software Engineer Intern", startDate: "May 2024", endDate: "Aug 2024", description: "Creating AI-powered tools for personalized DIY trips.", techStack: [ReactIcon, TypescriptIcon, NextJsIcon, LangchainIcon, OpenAIIcon] },
