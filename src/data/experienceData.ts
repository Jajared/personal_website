...
import { AwsIcon, CPPIcon, DjangoIcon, DockerIcon, DotNetIcon, ExpressJsIcon, FirebaseIcon, JavascriptIcon, AzureIcon, KubernetesIcon, LangchainIcon, MongoDbIcon, NestJsIcon, NextJsIcon, OpenAIIcon, PostgresqlIcon, PrismaIcon, PythonIcon, ReactIcon, TypescriptIcon } from "../components/DevIcons";

export const experienceData: ExperienceItemData[] = [
  { company: "NUS School of Computing", company_icon: NUSLogo, role: "Research Engineer", startDate: "Jan 2026", endDate: "Apr 2026", description: "Supply chain tracking using Blockchain technology", techStack: [JavascriptIcon, ReactIcon, ExpressJsIcon, MongoDbIcon] },
  { company: "Fortifai", company_icon: FortifaiLogo, role: "Software Engineer Intern", startDate: "July 2025", endDate: "Dec 2025", description: "Simplifying ESG Compliance for SMEs", techStack: [TypescriptIcon, ReactIcon, CPPIcon, DotNetIcon, PostgresqlIcon, AzureIcon] },
  { company: "Pints.ai", company_icon: PintsaiLogo, role: "Software Engineer Intern", startDate: "Oct 2024", endDate: "May 2025", description: "Building next-gen AI applications with compact LLMs", techStack: [NextJsIcon, TypescriptIcon, PostgresqlIcon, ExpressJsIcon, PrismaIcon, DjangoIcon, PythonIcon, LangchainIcon, AwsIcon, KubernetesIcon, DockerIcon] },
